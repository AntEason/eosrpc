...
import com.cssc.eos.crypto.model.types.EosType;
import com.cssc.eos.crypto.util.BitUtils;
import com.cssc.eos.crypto.util.HexUtils;
...
public class TransactionHeader implements EosType.Packer {
    ...
    public void setReferenceBlock( String refBlockIdAsSha256 ) {
        ...
        ref_block_prefix = //new BigInteger( 1, HexUtils.toBytesReversed( refBlockIdAsSha256.substring(16,24))).longValue();
                BitUtils.uint32ToLong(HexUtils.toBytes(refBlockIdAsSha256.substring(16,24)), 0); // BitUtils treats bytes in little endian.// so, no need to reverse bytes.
    }
